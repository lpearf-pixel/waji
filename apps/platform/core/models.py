...
class Capture(models.Model):
    ...
    raw_file = models.FileField(upload_to=capture_audio_path)
    ...
    position_photo = models.FileField(upload_to=position_photo_path, null=True, blank=True)
    ...
    processed_file = models.FileField(upload_to=processed_audio_path, null=True, blank=True)
